# The §4.1 / §5.2 rules for describing an issue in a VEKTIS event's `properties`.
#
# Named for mtasks rather than nested under Vektis:: — that namespace belongs to the vektis-rails
# gem now, and this is the app's own mapping from its domain onto the registry's property keys.
#
...
module IssueTrackingProperties
